...
- 离散数学的重要性
    - 离散数学包含的数理逻辑(证明语言)，集合论，数论，组合数学，图论等对于理解现代数学的工具多样性非常重要
- 数学应用或modelling很重要
...
- 数学分析('连续数学')虽然重要，但还没必要看数学分析的教材
    ...
    - 连续数学中要学线代，[线性代数不是离散数学](https://www.quora.com/Is-linear-algebra-discrete-math)，线代 is a form of continuous，但matrix theory在离散数学里面
